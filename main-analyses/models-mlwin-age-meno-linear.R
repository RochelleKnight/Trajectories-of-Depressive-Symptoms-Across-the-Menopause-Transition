...
ggsave("Final plots/Trajectory of Depression Over Chronological Age (age meno contin).png", width = 11.69, height = 8.27,bg = "white")
...
ggsave("Final plots/Trajectory of Depression Over Chronological Age (age meno contin + CIs).png", width = 11.69, height = 8.27, units = "in")
...
ggplot(pred_df_model2, aes(x = age, y = predicted, colour = age_meno_cat)) +
  ...
  scale_colour_manual(values = c(
    "Age at menopause aged 40 - 45" = "#1f78b4",
    "Age at menopause 45 or above" = "#33a02c"
  )) 


ggsave("Final plots/Age at menopause categorical.png", width = 11.69, height = 8.27, units = "in", bg = "white")
...
ggsave("Final plots/Age at menopause categorical with CIs.png", width = 11.69, height = 8.27, units = "in", bg = "white")
